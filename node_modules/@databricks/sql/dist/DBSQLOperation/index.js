...
class DBSQLOperation {
    constructor(driver, operationHandle, logger, directResults) {
        ...
        this._data = new FetchResultsHelper_1.default(this.driver, this.operationHandle, [directResults === null || directResults === void 0 ? void 0 : directResults.resultSet], useOnlyPrefetchedResults);
    ...
    fetchChunk(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [resultHandler, data] = yield Promise.all([
                this._schema.getResultHandler(),
                this._data.fetch((options === null || options === void 0 ? void 0 : options.maxRows) || defaultMaxRows),
            ]);
    ...
    cancel() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log(IDBSQLLogger_1.LogLevel.debug, `Cancelling operation with id: ${this.getId()}`);
