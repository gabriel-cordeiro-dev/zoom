...
class DBSQLClient extends events_1.EventEmitter {
    ...
    connect(options, authProvider) {
        return __awaiter(this, void 0, void 0, function* () {
            this.authProvider =
                authProvider ||
                    new PlainHttpAuthentication_1.default({
                        username: 'token',
    ...
    openSession(request = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!((_a = this.connection) === null || _a === void 0 ? void 0 : _a.isConnected())) {
                throw new HiveDriverError_1.default('DBSQLClient: connection is lost');
            }
            const driver = new HiveDriver_1.default(this.getClient());
            const response = yield driver.openSession(Object.assign({ client_protocol_i64: new Types_1.Int64(TCLIService_types_1.TProtocolVersion.SPARK_CLI_SERVICE_PROTOCOL_V6) }, getInitialNamespaceOptions(request.initialCatalog, request.initialSchema)));
